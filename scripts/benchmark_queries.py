    ...
    return {
        "news_list": _measure(
            ...
            lambda: list_articles_fn(
                {"page": 1, "size": 20, "q": "budget", "source": "bench-source",
        ...
        "minutes_list": _measure(
            ...
            lambda: list_minutes_fn(
                {"page": 1, "size": 20, "q": "agenda", "council": "seoul",
                 "committee": "budget", "session": "301", "meeting_no": None,
                 "date_from": "2026-02-01", "date_to": "2026-02-28"},
                connection_provider=connection_provider,
            ),
            runs=runs,
        ...
        "segments_list": _measure(
            ...
            lambda: list_segments_fn(
                {"page": 1, "size": 20, "q": "segment", "council": "seoul",
                 "committee": "budget", "session": "301", "meeting_no": None,
                 "importance": 2, "party": "party-a", "constituency": "district-1",
                 "department": "finance", "date_from": "2026-02-01", "date_to": "2026-02-28"},
                connection_provider=connection_provider,
            ),
            runs=runs,
        ),
