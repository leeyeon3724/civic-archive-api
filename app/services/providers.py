...
from app.services.minutes_service import MinutesService, build_minutes_service
from app.services.news_service import NewsService, build_news_service
from app.services.segments_service import SegmentsService, build_segments_service
...
def get_segments_service(request: Request) -> SegmentsService:
